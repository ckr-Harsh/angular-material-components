...
function createMissingDateImplError(provider) {
  return Error("MatDatepicker: No provider found for ".concat(provider, ". You must add one of the following ") + "to your app config: provideNativeDateAdapter, provideDateFnsAdapter, provideLuxonDateAdapter, provideMomentDateAdapter, or provide a custom implementation.");
}
var _MatDatepickerIntl = class _MatDatepickerIntl {
  constructor() {
    ...
    __publicField(this, "calendarLabel", "Calendar");
    /** A label for the button used to open the calendar popup (used by screen readers). */
    __publicField(this, "openCalendarLabel", "Open calendar");
    /** Label for the button used to close the calendar popup. */
    __publicField(this, "closeCalendarLabel", "Close calendar");
    /** A label for the previous month button (used by screen readers). */
    __publicField(this, "prevMonthLabel", "Previous month");
    /** A label for the next month button (used by screen readers). */
    __publicField(this, "nextMonthLabel", "Next month");
    /** A label for the previous year button (used by screen readers). */
    __publicField(this, "prevYearLabel", "Previous year");
    /** A label for the next year button (used by screen readers). */
    __publicField(this, "nextYearLabel", "Next year");
    /** A label for the previous multi-year button (used by screen readers). */
    __publicField(this, "prevMultiYearLabel", "Previous 24 years");
    /** A label for the next multi-year button (used by screen readers). */
    __publicField(this, "nextMultiYearLabel", "Next 24 years");
    /** A label for the 'switch to month view' button (used by screen readers). */
    __publicField(this, "switchToMonthViewLabel", "Choose date");
    /** A label for the 'switch to year view' button (used by screen readers). */
    __publicField(this, "switchToMultiYearViewLabel", "Choose month and year");
    /**
     * A label for the first date of a range of dates (used by screen readers).
     * @deprecated Provide your own internationalization string.
     * @breaking-change 17.0.0
     */
    __publicField(this, "startDateLabel", "Start date");
    /**
     * A label for the last date of a range of dates (used by screen readers).
     * @deprecated Provide your own internationalization string.
     * @breaking-change 17.0.0
     */
    __publicField(this, "endDateLabel", "End date");
    /**
     * A label for the Comparison date of a range of dates (used by screen readers).
     */
    __publicField(this, "comparisonDateLabel", "Comparison range");
  }
...
__publicField(_MatDatepickerIntl, "\u0275fac", function MatDatepickerIntl_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDatepickerIntl)();
});
__publicField(_MatDatepickerIntl, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var MatCalendarCell = class {
  constructor(value, displayValue, ariaLabel, enabled, cssClasses = {}, compareValue = value, rawValue) {
    ...
    __publicField(this, "displayValue");
    __publicField(this, "ariaLabel");
    __publicField(this, "enabled");
    __publicField(this, "cssClasses");
    __publicField(this, "compareValue");
    __publicField(this, "rawValue");
    __publicField(this, "id", uniqueIdCounter$1++);
    this.value = value;
...
var _MatCalendarBody = class _MatCalendarBody {
  constructor() {
    ...
    __publicField(this, "_intl", inject(MatDatepickerIntl));
    __publicField(this, "_eventCleanups");
    /**
     * Used to skip the next focus event when rendering the preview range.
     * We need a flag like this, because some browsers fire focus events asynchronously.
     */
    __publicField(this, "_skipNextFocus");
    /**
     * Used to focus the active cell after change detection has run.
     */
    __publicField(this, "_focusActiveCellAfterViewChecked", false);
    /** The label for the table. (e.g. "Jan 2017"). */
    __publicField(this, "label");
    /** The cells to display in the table. */
    __publicField(this, "rows");
    /** The value in the table that corresponds to today. */
    __publicField(this, "todayValue");
    /** Start value of the selected date range. */
    __publicField(this, "startValue");
    /** End value of the selected date range. */
    __publicField(this, "endValue");
    /** The minimum number of free cells needed to fit the label in the first row. */
    __publicField(this, "labelMinRequiredCells");
    /** The number of columns in the table. */
    __publicField(this, "numCols", 7);
    /** The cell number of the active cell in the table. */
    __publicField(this, "activeCell", 0);
     ...
     */
    __publicField(this, "cellAspectRatio", 1);
    /** Start of the comparison range. */
    __publicField(this, "comparisonStart");
    /** End of the comparison range. */
    __publicField(this, "comparisonEnd");
    /** Start of the preview range. */
    __publicField(this, "previewStart", null);
    /** End of the preview range. */
    __publicField(this, "previewEnd", null);
    /** ARIA Accessible name of the `<input matStartDate/>` */
    __publicField(this, "startDateAccessibleName");
    /** ARIA Accessible name of the `<input matEndDate/>` */
    __publicField(this, "endDateAccessibleName");
    /** Emits when a new value is selected. */
    __publicField(this, "selectedValueChange", new EventEmitter());
    /** Emits when the preview has changed as a result of a user action. */
    __publicField(this, "previewChange", new EventEmitter());
    __publicField(this, "activeDateChange", new EventEmitter());
    /** Emits the date at the possible start of a drag event. */
    __publicField(this, "dragStarted", new EventEmitter());
    /** Emits the date at the conclusion of a drag, or null if mouse was not released on a date. */
    __publicField(this, "dragEnded", new EventEmitter());
    /** The number of blank cells to put at the beginning for the first row. */
    __publicField(this, "_firstRowOffset");
    /** Padding for the individual date cells. */
    __publicField(this, "_cellPadding");
    /** Width of an individual cell. */
    __publicField(this, "_cellWidth");
    /** ID for the start date label. */
    __publicField(this, "_startDateLabelId");
    /** ID for the end date label. */
    __publicField(this, "_endDateLabelId");
    /** ID for the comparison start date label. */
    __publicField(this, "_comparisonStartDateLabelId");
    /** ID for the comparison end date label. */
    __publicField(this, "_comparisonEndDateLabelId");
    __publicField(this, "_didDragSinceMouseDown", false);
    __publicField(this, "_injector", inject(Injector));
    __publicField(this, "comparisonDateAccessibleName", this._intl.comparisonDateLabel);
    /**
     * Tracking function for rows based on their identity. Ideally we would use some sort of
     * key on the row, but that would require a breaking change for the `rows` input. We don't
     * use the built-in identity tracking, because it logs warnings.
     */
    __publicField(this, "_trackRow", (row) => row);
    /**
     * Event handler for when the user enters an element
     * inside the calendar body (e.g. by hovering in or focus).
     */
    __publicField(this, "_enterHandler", (event) => {
    ...
    __publicField(this, "_touchmoveHandler", (event) => {
     ...
     */
    __publicField(this, "_leaveHandler", (event) => {
     ...
     */
    __publicField(this, "_mousedownHandler", (event) => {
      if (!this.isRange) return;
    ...
    __publicField(this, "_mouseupHandler", (event) => {
      if (!this.isRange) return;
      ...
      this._ngZone.run(() => {
        ...
        this.dragEnded.emit({
          value: (_a = cell == null ? void 0 : cell.rawValue) != null ? _a : null,
          event
        });
      });
    });
    /** Triggered on touchend anywhere. Respsonsible for ending a drag sequence. */
    __publicField(this, "_touchendHandler", (event) => {
      const target = getActualTouchTarget(event);
      if (target) {
  ...
  _getDescribedby(value) {
    ...
    if (this.comparisonStart !== null && this.comparisonEnd !== null) {
      if (value === this.comparisonStart && value === this.comparisonEnd) {
        return "".concat(this._comparisonStartDateLabelId, " ").concat(this._comparisonEndDateLabelId);
...
__publicField(_MatCalendarBody, "\u0275fac", function MatCalendarBody_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatCalendarBody)();
});
__publicField(_MatCalendarBody, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
var DateRange = class {
  constructor(start, end) {
    ...
    __publicField(this, "_disableStructuralEquivalency");
    this.start = start;
    this.end = end;
  }
};
var _MatDateSelectionModel = class _MatDateSelectionModel {
  constructor(selection, _adapter) {
    ...
    __publicField(this, "_selectionChanged", new Subject());
    /** Emits when the selection has changed. */
    __publicField(this, "selectionChanged", this._selectionChanged);
...
__publicField(_MatDateSelectionModel, "\u0275fac", function MatDateSelectionModel_Factory(__ngFactoryType__) {
  \u0275\u0275invalidFactory();
});
__publicField(_MatDateSelectionModel, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
__publicField(_MatSingleDateSelectionModel, "\u0275fac", function MatSingleDateSelectionModel_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatSingleDateSelectionModel)(\u0275\u0275inject(DateAdapter));
});
__publicField(_MatSingleDateSelectionModel, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
__publicField(_MatRangeDateSelectionModel, "\u0275fac", function MatRangeDateSelectionModel_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatRangeDateSelectionModel)(\u0275\u0275inject(DateAdapter));
});
__publicField(_MatRangeDateSelectionModel, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var _DefaultMatCalendarRangeStrategy = class _DefaultMatCalendarRangeStrategy {
  constructor(_dateAdapter) {
    __publicField(this, "_dateAdapter");
...
__publicField(_DefaultMatCalendarRangeStrategy, "\u0275fac", function DefaultMatCalendarRangeStrategy_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _DefaultMatCalendarRangeStrategy)(\u0275\u0275inject(DateAdapter));
});
__publicField(_DefaultMatCalendarRangeStrategy, "\u0275prov", /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var _MatMonthView = class _MatMonthView {
  constructor() {
    ...
    __publicField(this, "_dateFormats", inject(MAT_DATE_FORMATS, {
      optional: true
    }));
    __publicField(this, "_dateAdapter", inject(DateAdapter, {
      optional: true
    }));
    __publicField(this, "_dir", inject(Directionality, {
      optional: true
    }));
    __publicField(this, "_rangeStrategy", inject(MAT_DATE_RANGE_SELECTION_STRATEGY, {
      optional: true
    }));
    __publicField(this, "_rerenderSubscription", Subscription.EMPTY);
    /** Flag used to filter out space/enter keyup events that originated outside of the view. */
    __publicField(this, "_selectionKeyPressed");
    __publicField(this, "_activeDate");
    __publicField(this, "_selected");
    __publicField(this, "_minDate");
    __publicField(this, "_maxDate");
    /** Function used to filter which dates are selectable. */
    __publicField(this, "dateFilter");
    /** Function that can be used to add custom CSS classes to dates. */
    __publicField(this, "dateClass");
    /** Start of the comparison range. */
    __publicField(this, "comparisonStart");
    /** End of the comparison range. */
    __publicField(this, "comparisonEnd");
    ...
    __publicField(this, "activeDrag", null);
    /** Emits when a new date is selected. */
    __publicField(this, "selectedChange", new EventEmitter());
    /** Emits when any date is selected. */
    __publicField(this, "_userSelection", new EventEmitter());
    ...
    __publicField(this, "_matCalendarBody");
    /** The label for this month (e.g. "January 2017"). */
    __publicField(this, "_monthLabel");
    /** Grid of calendar cells representing the dates of the month. */
    __publicField(this, "_weeks");
    /** The number of blank cells in the first row before the 1st of the month. */
    __publicField(this, "_firstWeekOffset");
    /** Start value of the currently-shown date range. */
    __publicField(this, "_rangeStart");
    /** End value of the currently-shown date range. */
    __publicField(this, "_rangeEnd");
    /** Start value of the currently-shown comparison date range. */
    __publicField(this, "_comparisonRangeStart");
    /** End value of the currently-shown comparison date range. */
    __publicField(this, "_comparisonRangeEnd");
    /** Start of the preview range. */
    __publicField(this, "_previewStart");
    /** End of the preview range. */
    __publicField(this, "_previewEnd");
    /** Whether the user is currently selecting a range of dates. */
    __publicField(this, "_isRange");
    /** The date of the month that today falls on. Null if today is in another month. */
    __publicField(this, "_todayDate");
    /** The names of the weekdays. */
    __publicField(this, "_weekdays");
  ...
  _dragEnded(event) {
    ...
    if (event.value) {
      ...
      this.dragEnded.emit({
        value: dragDropResult != null ? dragDropResult : null,
        event: event.event
      });
    } else {
      this.dragEnded.emit({
...
__publicField(_MatMonthView, "\u0275fac", function MatMonthView_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatMonthView)();
});
__publicField(_MatMonthView, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
  type: _MatMonthView,
...
var _MatMultiYearView = class _MatMultiYearView {
  constructor() {
    ...
    __publicField(this, "yearSelected", new EventEmitter());
    /** Emits when any date is activated. */
    __publicField(this, "activeDateChange", new EventEmitter());
    /** The body of calendar table */
    __publicField(this, "_matCalendarBody");
    /** Grid of calendar cells representing the currently displayed years. */
    __publicField(this, "_years");
    /** The year that today falls on. */
    __publicField(this, "_todayYear");
    /** The year of the selected date. Null if the selected date is null. */
    __publicField(this, "_selectedYear");
...
__publicField(_MatMultiYearView, "\u0275fac", function MatMultiYearView_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatMultiYearView)();
});
__publicField(_MatMultiYearView, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
var _MatYearView = class _MatYearView {
  constructor() {
    ...
    __publicField(this, "monthSelected", new EventEmitter());
    /** Emits when any date is activated. */
    __publicField(this, "activeDateChange", new EventEmitter());
    /** The body of calendar table */
    __publicField(this, "_matCalendarBody");
    /** Grid of calendar cells representing the months of the year. */
    __publicField(this, "_months");
    /** The label for this year (e.g. "2017"). */
    __publicField(this, "_yearLabel");
    /** The month in this year that today falls on. Null if today is in a different year. */
    __publicField(this, "_todayMonth");
    /**
     * The month in this year that the selected Date falls on.
     * Null if the selected Date is in a different year.
     */
    __publicField(this, "_selectedMonth");
    if (typeof ngDevMode === "undefined" || ngDevMode) {
      if (!this._dateAdapter) {
        throw createMissingDateImplError("DateAdapter");
      }
...
__publicField(_MatYearView, "\u0275fac", function MatYearView_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatYearView)();
});
__publicField(_MatYearView, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
  type: _MatYearView,
...
var _MatCalendarHeader = class _MatCalendarHeader {
  constructor() {
    __publicField(this, "_intl", inject(MatDatepickerIntl));
    __publicField(this, "calendar", inject(MatCalendar));
    __publicField(this, "_dateAdapter", inject(DateAdapter, {
      optional: true
    }));
    __publicField(this, "_dateFormats", inject(MAT_DATE_FORMATS, {
    ...
    __publicField(this, "_periodButtonLabelId", inject(_IdGenerator).getId("mat-calendar-period-label-"));
    inject(_CdkPrivateStyleLoader).load(_VisuallyHiddenLoader);
...
__publicField(_MatCalendarHeader, "\u0275fac", function MatCalendarHeader_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatCalendarHeader)();
});
__publicField(_MatCalendarHeader, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
var _MatCalendar = class _MatCalendar {
  constructor() {
    ...
    __publicField(this, "headerComponent");
    /** A portal containing the header component type for this calendar. */
    __publicField(this, "_calendarHeaderPortal");
    __publicField(this, "_intlChanges");
    /**
     * Used for scheduling that focus should be moved to the active cell on the next tick.
     * We need to schedule it, rather than do it immediately, because we have to wait
     * for Angular to re-evaluate the view children.
     */
    __publicField(this, "_moveFocusOnNextTick", false);
    __publicField(this, "_startAt");
    /** Whether the calendar should be started in month or year view. */
    __publicField(this, "startView", "month");
    __publicField(this, "_selected");
    __publicField(this, "_minDate");
    __publicField(this, "_maxDate");
    /** Function used to filter which dates are selectable. */
     ...
     */
    __publicField(this, "viewChanged", new EventEmitter(true));
    /** Emits when any date is selected. */
    __publicField(this, "_userSelection", new EventEmitter());
    /** Emits a new date range value when the user completes a drag drop operation. */
    __publicField(this, "_userDragDrop", new EventEmitter());
    /** Reference to the current month view component. */
    __publicField(this, "monthView");
    /** Reference to the current year view component. */
    __publicField(this, "yearView");
    /** Reference to the current multi-year view component. */
    __publicField(this, "multiYearView");
    __publicField(this, "_clampedActiveDate");
    __publicField(this, "_currentView");
    /** Origin of active drag, or null when dragging is not active. */
    __publicField(this, "_activeDrag", null);
    /**
...
__publicField(_MatCalendar, "\u0275fac", function MatCalendar_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatCalendar)();
});
__publicField(_MatCalendar, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
  type: _MatCalendar,
...
var _MatDatepickerContent = class _MatDatepickerContent {
  constructor() {
    __publicField(this, "_elementRef", inject(ElementRef));
    __publicField(this, "_animationsDisabled", inject(ANIMATION_MODULE_TYPE, {
      optional: true
    }) === "NoopAnimations");
    __publicField(this, "_changeDetectorRef", inject(ChangeDetectorRef));
    __publicField(this, "_globalModel", inject(MatDateSelectionModel));
    __publicField(this, "_dateAdapter", inject(DateAdapter));
    __publicField(this, "_ngZone", inject(NgZone));
    __publicField(this, "_rangeSelectionStrategy", inject(MAT_DATE_RANGE_SELECTION_STRATEGY, {
      optional: true
    }));
    __publicField(this, "_stateChanges");
    __publicField(this, "_model");
    __publicField(this, "_eventCleanups");
    __publicField(this, "_animationFallback");
    /** Reference to the internal calendar component. */
    __publicField(this, "_calendar");
    /**
    ...
    __publicField(this, "_isAbove");
    /** Emits when an animation has finished. */
    __publicField(this, "_animationDone", new Subject());
    /** Whether there is an in-progress animation. */
    __publicField(this, "_isAnimating", false);
    /** Text for the close button. */
    __publicField(this, "_closeButtonText");
    /** Whether the close button currently has focus. */
    __publicField(this, "_closeButtonFocused");
    /** Portal with projected action buttons. */
    __publicField(this, "_actionsPortal", null);
    /** Id of the label for the `role="dialog"` element. */
    __publicField(this, "_dialogLabelId");
    __publicField(this, "_handleAnimationEvent", (event) => {
      const element = this._elementRef.nativeElement;
  ...
  ngOnDestroy() {
    var _a, _b;
    clearTimeout(this._animationFallback);
    (_a = this._eventCleanups) == null ? void 0 : _a.forEach((cleanup) => cleanup());
    (_b = this._stateChanges) == null ? void 0 : _b.unsubscribe();
...
__publicField(_MatDatepickerContent, "\u0275fac", function MatDatepickerContent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDatepickerContent)();
});
__publicField(_MatDatepickerContent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
var _MatDatepickerBase = class _MatDatepickerBase {
  constructor() {
    ...
    __publicField(this, "_model", inject(MatDateSelectionModel));
    __publicField(this, "_scrollStrategy", inject(MAT_DATEPICKER_SCROLL_STRATEGY));
    __publicField(this, "_inputStateChanges", Subscription.EMPTY);
    __publicField(this, "_document", inject(DOCUMENT));
    /** An input indicating the type of the custom header component for the calendar, if set. */
    __publicField(this, "calendarHeaderComponent");
    __publicField(this, "_startAt");
     ...
     */
    __publicField(this, "touchUi", false);
    __publicField(this, "_disabled");
    /** Preferred position of the datepicker in the X axis. */
    __publicField(this, "xPosition", "start");
    /** Preferred position of the datepicker in the Y axis. */
    __publicField(this, "yPosition", "below");
    /**
    ...
    __publicField(this, "openedStream", new EventEmitter());
    /** Emits when the datepicker has been closed. */
    __publicField(this, "closedStream", new EventEmitter());
    __publicField(this, "_panelClass");
    __publicField(this, "_opened", false);
    /** The id for the datepicker calendar. */
    __publicField(this, "id", inject(_IdGenerator).getId("mat-datepicker-"));
    /** A reference to the overlay into which we've rendered the calendar. */
    __publicField(this, "_overlayRef");
    /** Reference to the component instance rendered in the overlay. */
    __publicField(this, "_componentRef");
    /** The element that was focused before the datepicker was opened. */
    __publicField(this, "_focusedElementBeforeOpen", null);
    /** Unique class that will be added to the backdrop so that the test harnesses can look it up. */
    __publicField(this, "_backdropHarnessClass", "".concat(this.id, "-backdrop"));
    /** Currently-registered actions portal. */
    __publicField(this, "_actionsPortal");
    /** The input element this datepicker is associated with. */
    __publicField(this, "datepickerInput");
...
__publicField(_MatDatepickerBase, "\u0275fac", function MatDatepickerBase_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDatepickerBase)();
});
__publicField(_MatDatepickerBase, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
__publicField(_MatDatepicker, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
  type: _MatDatepicker,
...
var _MatDatepickerInputBase = class _MatDatepickerInputBase {
  constructor() {
    ...
    __publicField(this, "dateChange", new EventEmitter());
    /** Emits when an `input` event is fired on this `<input>`. */
    __publicField(this, "dateInput", new EventEmitter());
    /** Emits when the internal state has changed */
    __publicField(this, "stateChanges", new Subject());
    __publicField(this, "_onTouched", () => {
    });
    __publicField(this, "_validatorOnChange", () => {
    });
    __publicField(this, "_cvaOnChange", () => {
    });
    __publicField(this, "_valueChangesSubscription", Subscription.EMPTY);
    __publicField(this, "_localeSubscription", Subscription.EMPTY);
    /**
    ...
    __publicField(this, "_parseValidator", () => {
    ...
    __publicField(this, "_filterValidator", (control) => {
    ...
    __publicField(this, "_minValidator", (control) => {
      const controlValue = this._dateAdapter.getValidDateOrNull(this._dateAdapter.deserialize(control.value));
    ...
    __publicField(this, "_maxValidator", (control) => {
      const controlValue = this._dateAdapter.getValidDateOrNull(this._dateAdapter.deserialize(control.value));
    ...
    __publicField(this, "_lastValueValid", false);
    if (typeof ngDevMode === "undefined" || ngDevMode) {
      if (!this._dateAdapter) {
        throw createMissingDateImplError("DateAdapter");
      }
...
__publicField(_MatDatepickerInputBase, "\u0275fac", function MatDatepickerInputBase_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDatepickerInputBase)();
});
__publicField(_MatDatepickerInputBase, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
var _MatDatepickerInput = class _MatDatepickerInput extends MatDatepickerInputBase {
  constructor() {
    super();
    __publicField(this, "_formField", inject(MAT_FORM_FIELD, {
      optional: true
    }));
    __publicField(this, "_closedSubscription", Subscription.EMPTY);
    __publicField(this, "_openedSubscription", Subscription.EMPTY);
    __publicField(this, "_datepicker");
    /** The id of the panel owned by this input. */
    __publicField(this, "_ariaOwns", signal(null));
    __publicField(this, "_min");
    __publicField(this, "_max");
    __publicField(this, "_dateFilter");
...
__publicField(_MatDatepickerInput, "\u0275fac", function MatDatepickerInput_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDatepickerInput)();
});
__publicField(_MatDatepickerInput, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
__publicField(_MatDatepickerToggleIcon, "\u0275fac", function MatDatepickerToggleIcon_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDatepickerToggleIcon)();
});
__publicField(_MatDatepickerToggleIcon, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
var _MatDatepickerToggle = class _MatDatepickerToggle {
  constructor() {
    __publicField(this, "_intl", inject(MatDatepickerIntl));
    __publicField(this, "_changeDetectorRef", inject(ChangeDetectorRef));
    __publicField(this, "_stateChanges", Subscription.EMPTY);
    ...
    __publicField(this, "_customIcon");
...
__publicField(_MatDatepickerToggle, "\u0275fac", function MatDatepickerToggle_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDatepickerToggle)();
});
__publicField(_MatDatepickerToggle, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
var _MatDateRangeInput = class _MatDateRangeInput {
  constructor() {
    ...
    __publicField(this, "_closedSubscription", Subscription.EMPTY);
    __publicField(this, "_openedSubscription", Subscription.EMPTY);
    __publicField(this, "_startInput");
    __publicField(this, "_endInput");
    /** Unique ID for the group. */
    __publicField(this, "id", inject(_IdGenerator).getId("mat-date-range-input-"));
    /** Whether the control is focused. */
    __publicField(this, "focused", false);
    /** Name of the form control. */
    __publicField(this, "controlType", "mat-date-range-input");
    __publicField(this, "_rangePicker");
    /** The id of the panel owned by this input. */
    __publicField(this, "_ariaOwns", signal(null));
    ...
    __publicField(this, "_min");
    __publicField(this, "_max");
    __publicField(this, "_groupDisabled", false);
    /** Value for the `aria-describedby` attribute of the inputs. */
    __publicField(this, "_ariaDescribedBy", null);
    /** Date selection model currently registered with the input. */
    __publicField(this, "_model");
    /** Separator text to be shown between the inputs. */
    __publicField(this, "separator", "\u2013");
    /** Start of the comparison range that should be shown in the calendar. */
    __publicField(this, "comparisonStart", null);
    /** End of the comparison range that should be shown in the calendar. */
    __publicField(this, "comparisonEnd", null);
    /**
     * Implemented as a part of `MatFormFieldControl`.
     * TODO(crisbeto): change type to `AbstractControlDirective` after #18206 lands.
     * @docs-private
     */
    __publicField(this, "ngControl");
     ...
     * @docs-private
     */
    __publicField(this, "disableAutomaticLabeling", true);
    var _a;
    if (!this._dateAdapter && (typeof ngDevMode === "undefined" || ngDevMode)) {
      throw createMissingDateImplError("DateAdapter");
    }
    if ((_a = this._formField) == null ? void 0 : _a._elementRef.nativeElement.classList.contains("mat-mdc-form-field")) {
...
__publicField(_MatDateRangeInput, "\u0275fac", function MatDateRangeInput_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDateRangeInput)();
});
__publicField(_MatDateRangeInput, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
var _MatDateRangeInputPartBase = class _MatDateRangeInputPartBase extends MatDatepickerInputBase {
  constructor() {
    super();
    __publicField(this, "_rangeInput", inject(MatDateRangeInput));
    __publicField(this, "_elementRef", inject(ElementRef));
    __publicField(this, "_defaultErrorStateMatcher", inject(ErrorStateMatcher));
    __publicField(this, "_injector", inject(Injector));
    __publicField(this, "_parentForm", inject(NgForm, {
      optional: true
    }));
    __publicField(this, "_parentFormGroup", inject(FormGroupDirective, {
      optional: true
    }));
    /**
    ...
    __publicField(this, "_errorStateTracker");
...
__publicField(_MatDateRangeInputPartBase, "\u0275fac", function MatDateRangeInputPartBase_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDateRangeInputPartBase)();
});
__publicField(_MatDateRangeInputPartBase, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
var _MatStartDate = class _MatStartDate extends MatDateRangeInputPartBase {
  constructor() {
    ...
    __publicField(this, "_startValidator", (control) => {
    ...
    __publicField(this, "_validator", Validators.compose([...super._getValidators(), this._startValidator]));
  }
  _register() {
...
__publicField(_MatStartDate, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
  type: _MatStartDate,
...
var _MatEndDate = class _MatEndDate extends MatDateRangeInputPartBase {
  constructor() {
    ...
    __publicField(this, "_endValidator", (control) => {
    ...
    __publicField(this, "_validator", Validators.compose([...super._getValidators(), this._endValidator]));
  }
  _register() {
...
__publicField(_MatEndDate, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
  type: _MatEndDate,
...
__publicField(_MatDateRangePicker, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
var _MatDatepickerApply = class _MatDatepickerApply {
  constructor() {
    __publicField(this, "_datepicker", inject(MatDatepickerBase));
  }
  _applySelection() {
...
__publicField(_MatDatepickerApply, "\u0275fac", function MatDatepickerApply_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDatepickerApply)();
});
__publicField(_MatDatepickerApply, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
__publicField(_MatDatepickerCancel, "\u0275fac", function MatDatepickerCancel_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDatepickerCancel)();
});
__publicField(_MatDatepickerCancel, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
__publicField(_MatDatepickerActions, "\u0275fac", function MatDatepickerActions_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDatepickerActions)();
});
__publicField(_MatDatepickerActions, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
__publicField(_MatDatepickerModule, "\u0275fac", function MatDatepickerModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDatepickerModule)();
});
__publicField(_MatDatepickerModule, "\u0275mod", /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _MatDatepickerModule
}));
__publicField(_MatDatepickerModule, "\u0275inj", /* @__PURE__ */ \u0275\u0275defineInjector({
...
//# sourceMappingURL=chunk-SGMMUF4F.js.map
