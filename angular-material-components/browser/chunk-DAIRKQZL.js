...
var loopLimitExceededErrorHandler = (e) => {
  if (e instanceof ErrorEvent && e.message === "ResizeObserver loop limit exceeded") {
    console.error("".concat(e.message, ". This could indicate a performance issue with your app. See https://github.com/WICG/resize-observer/blob/master/explainer.md#error-handling"));
  }
};
var SingleBoxSharedResizeObserver = class {
  constructor(_box) {
    ...
    __publicField(this, "_resizeSubject", new Subject());
    /** ResizeObserver used to observe element resize events. */
    __publicField(this, "_resizeObserver");
    /** A map of elements to streams of their resize events. */
    __publicField(this, "_elementObservables", /* @__PURE__ */ new Map());
    this._box = _box;
...
var _SharedResizeObserver = class _SharedResizeObserver {
  constructor() {
    __publicField(this, "_cleanupErrorListener");
...
var _MatError = class _MatError {
  constructor() {
    __publicField(this, "id", inject(_IdGenerator).getId("mat-mdc-error-"));
  }
};
...
var _MatHint = class _MatHint {
  constructor() {
    ...
    __publicField(this, "align", "start");
    /** Unique ID for the hint. Used for the aria-describedby on the form field control. */
    __publicField(this, "id", inject(_IdGenerator).getId("mat-mdc-hint-"));
  }
};
...
var _MatPrefix = class _MatPrefix {
  constructor() {
    __publicField(this, "_isText", false);
  }
...
var _MatFormFieldFloatingLabel = class _MatFormFieldFloatingLabel {
  constructor() {
    ...
    __publicField(this, "_floating", false);
    __publicField(this, "_monitorResize", false);
    /** The shared ResizeObserver. */
    __publicField(this, "_resizeObserver", inject(SharedResizeObserver));
    /** The Angular zone. */
    __publicField(this, "_ngZone", inject(NgZone));
    /** The parent form-field. */
    __publicField(this, "_parent", inject(FLOATING_LABEL_PARENT));
    /** The current resize event subscription. */
    __publicField(this, "_resizeSubscription", new Subscription());
  }
...
var _MatFormFieldLineRipple = class _MatFormFieldLineRipple {
  constructor() {
    __publicField(this, "_elementRef", inject(ElementRef));
    __publicField(this, "_cleanupTransitionEnd");
    __publicField(this, "_handleTransitionEnd", (event) => {
...
var _MatFormFieldNotchedOutline = class _MatFormFieldNotchedOutline {
  ...
  _setNotchWidth(labelWidth) {
    if (!this.open || !labelWidth) {
      ...
      this._notch.nativeElement.style.width = "calc(".concat(labelWidth, "px * var(--mat-mdc-form-field-floating-label-scale, 0.75) + ").concat(NOTCH_ELEMENT_PADDING + NOTCH_ELEMENT_BORDER, "px)");
    }
  }
};
...
var _MatFormFieldControl = class _MatFormFieldControl {
  constructor() {
     ...
     */
    __publicField(this, "stateChanges");
    ...
    __publicField(this, "shouldLabelFloat");
    /** Whether the control is required. */
    __publicField(this, "required");
    /** Whether the control is disabled. */
    __publicField(this, "disabled");
    /** Whether the control is in an error state. */
    __publicField(this, "errorState");
    /**
     * An optional name for the control type that can be used to distinguish `mat-form-field` elements
     * based on their control type. The form field will add a class,
     * `mat-form-field-type-{{controlType}}` to its root element.
     */
    __publicField(this, "controlType");
    /**
     * Whether the input is currently in an autofilled state. If property is not present on the
     * control it is assumed to be false.
     */
    __publicField(this, "autofilled");
    /**
     * Value of `aria-describedby` that should be merged with the described-by ids
     * which are set by the form-field.
     */
    __publicField(this, "userAriaDescribedBy");
    /**
     * Whether to automatically assign the ID of the form field as the `for` attribute
     * on the `<label>` inside the form field. Set this to true to prevent the form
     * field from associating the label with non-native elements.
     */
    __publicField(this, "disableAutomaticLabeling");
  }
};
...
var _MatFormField = class _MatFormField {
  constructor() {
    ...
    __publicField(this, "_defaults", inject(MAT_FORM_FIELD_DEFAULT_OPTIONS, {
      optional: true
    }));
    __publicField(this, "_textField");
    __publicField(this, "_iconPrefixContainer");
    __publicField(this, "_textPrefixContainer");
    __publicField(this, "_iconSuffixContainer");
    __publicField(this, "_textSuffixContainer");
    __publicField(this, "_floatingLabel");
    __publicField(this, "_notchedOutline");
    __publicField(this, "_lineRipple");
    __publicField(this, "_formFieldControl");
    __publicField(this, "_prefixChildren");
    __publicField(this, "_suffixChildren");
    __publicField(this, "_errorChildren");
    __publicField(this, "_hintChildren");
    __publicField(this, "_labelChild", contentChild(MatLabel));
    __publicField(this, "_hideRequiredMarker", false);
    /**
    ...
    __publicField(this, "_floatLabel");
    __publicField(this, "_appearance", DEFAULT_APPEARANCE);
    __publicField(this, "_subscriptSizing", null);
    __publicField(this, "_hintLabel", "");
    __publicField(this, "_hasIconPrefix", false);
    __publicField(this, "_hasTextPrefix", false);
    __publicField(this, "_hasIconSuffix", false);
    __publicField(this, "_hasTextSuffix", false);
    // Unique id for the internal form field label.
    __publicField(this, "_labelId", this._idGenerator.getId("mat-mdc-form-field-label-"));
    // Unique id for the hint label.
    __publicField(this, "_hintLabelId", this._idGenerator.getId("mat-mdc-hint-"));
    __publicField(this, "_destroyed", new Subject());
    __publicField(this, "_isFocused", null);
    __publicField(this, "_explicitFormFieldControl");
    __publicField(this, "_needsOutlineLabelOffsetUpdate", false);
    __publicField(this, "_previousControl", null);
    __publicField(this, "_previousControlValidatorFn", null);
    __publicField(this, "_stateChanges");
    __publicField(this, "_valueChanges");
    __publicField(this, "_describedByChanges");
    __publicField(this, "_animationsDisabled");
    /**
     * Gets the id of the label element. If no label is present, returns `null`.
     */
    __publicField(this, "getLabelId", computed(() => this._hasFloatingLabel() ? this._labelId : null));
    __publicField(this, "_hasFloatingLabel", computed(() => !!this._labelChild()));
  ...
  set appearance(value) {
    ...
    if (typeof ngDevMode === "undefined" || ngDevMode) {
      if (newAppearance !== "fill" && newAppearance !== "outline") {
        throw new Error('MatFormField: Invalid appearance "'.concat(newAppearance, '", valid values are "fill" or "outline".'));
      }
    }
  ...
  ngOnDestroy() {
    ...
    (_c11 = this._describedByChanges) == null ? void 0 : _c11.unsubscribe();
    this._destroyed.next();
    this._destroyed.complete();
  }
  /**
  ...
  _initializeControl(previousControl) {
    ...
    (_c11 = this._valueChanges) == null ? void 0 : _c11.unsubscribe();
  ...
  _updateFocusState() {
    ...
    (_c11 = this._textField) == null ? void 0 : _c11.nativeElement.classList.toggle("mdc-text-field--focused", this._control.focused);
  }
  /**
  ...
  _updateOutlineLabelOffset() {
    var _a2, _b2, _c11, _d2, _e2, _f2, _g2, _h;
    ...
    const iconSuffixContainer = (_c11 = this._iconSuffixContainer) == null ? void 0 : _c11.nativeElement;
    ...
    const prefixWidth = "".concat(iconPrefixContainerWidth + textPrefixContainerWidth, "px");
    const labelOffset = "var(--mat-mdc-form-field-label-offset-x, 0px)";
    const labelHorizontalOffset = "calc(".concat(negate, " * (").concat(prefixWidth, " + ").concat(labelOffset, "))");
    floatingLabel.style.transform = "var(\n        --mat-mdc-form-field-label-transform,\n        ".concat(FLOATING_LABEL_DEFAULT_DOCKED_TRANSFORM, " translateX(").concat(labelHorizontalOffset, ")\n    )");
    ...
    this._elementRef.nativeElement.style.setProperty("--mat-form-field-notch-max-width", "calc(100% - ".concat(prefixAndSuffixWidth, "px)"));
  }
...
__publicField(__CdkTextFieldStyleLoader, "\u0275fac", function _CdkTextFieldStyleLoader_Factory(__ngFactoryType__) {
...
var _AutofillMonitor = class _AutofillMonitor {
  constructor() {
    ...
    __publicField(this, "_monitoredElements", /* @__PURE__ */ new Map());
  }
...
__publicField(_AutofillMonitor, "\u0275fac", function AutofillMonitor_Factory(__ngFactoryType__) {
...
var _CdkAutofill = class _CdkAutofill {
  constructor() {
    __publicField(this, "_elementRef", inject(ElementRef));
    __publicField(this, "_autofillMonitor", inject(AutofillMonitor));
    /** Emits when the autofill state of the element changes. */
    __publicField(this, "cdkAutofill", new EventEmitter());
  }
  ngOnInit() {
...
__publicField(_CdkAutofill, "\u0275fac", function CdkAutofill_Factory(__ngFactoryType__) {
...
var _CdkTextareaAutosize = class _CdkTextareaAutosize {
  constructor() {
    ...
    __publicField(this, "_resizeEvents", new Subject());
    /** Keep track of the previous textarea value to avoid resizing when the value hasn't changed. */
    __publicField(this, "_previousValue");
    __publicField(this, "_initialHeight");
    __publicField(this, "_destroyed", new Subject());
    __publicField(this, "_listenerCleanups");
    __publicField(this, "_minRows");
    __publicField(this, "_maxRows");
     ...
     */
    __publicField(this, "_previousMinRows", -1);
    __publicField(this, "_textareaElement");
    /** Cached height of a textarea with a single row. */
    __publicField(this, "_cachedLineHeight");
    /** Cached height of a textarea with only the placeholder. */
    __publicField(this, "_cachedPlaceholderHeight");
    /** Cached scroll top of a textarea */
    __publicField(this, "_cachedScrollTop");
    /** Used to reference correct document/window */
    __publicField(this, "_document", inject(DOCUMENT, {
      optional: true
    }));
    __publicField(this, "_hasFocus");
    __publicField(this, "_isViewInited", false);
    /** Handles `focus` and `blur` events. */
    __publicField(this, "_handleFocusEvent", (event) => {
...
__publicField(_CdkTextareaAutosize, "\u0275fac", function CdkTextareaAutosize_Factory(__ngFactoryType__) {
...
__publicField(_TextFieldModule, "\u0275fac", function TextFieldModule_Factory(__ngFactoryType__) {
...
var _ErrorStateTracker = class {
  constructor(_defaultMatcher, ngControl, _parentFormGroup, _parentForm, _stateChanges) {
    __publicField(this, "_defaultMatcher");
    __publicField(this, "ngControl");
    __publicField(this, "_parentFormGroup");
    __publicField(this, "_parentForm");
    __publicField(this, "_stateChanges");
    /** Whether the tracker is currently in an error state. */
    __publicField(this, "errorState", false);
...
var _MatInput = class _MatInput {
  constructor() {
    ...
    __publicField(this, "_renderer", inject(Renderer2));
    __publicField(this, "_uid", inject(_IdGenerator).getId("mat-input-"));
    __publicField(this, "_previousNativeValue");
    __publicField(this, "_inputValueAccessor");
    __publicField(this, "_signalBasedValueAccessor");
    __publicField(this, "_previousPlaceholder");
    __publicField(this, "_errorStateTracker");
    __publicField(this, "_config", inject(MAT_INPUT_CONFIG, {
      optional: true
    }));
    __publicField(this, "_cleanupIosKeyup");
    __publicField(this, "_cleanupWebkitWheel");
    /** `aria-describedby` IDs assigned by the form field. */
    __publicField(this, "_formFieldDescribedBy");
    /** Whether the component is being rendered on the server. */
    __publicField(this, "_isServer");
    /** Whether the component is a native html select. */
    __publicField(this, "_isNativeSelect");
    /** Whether the component is a textarea. */
    __publicField(this, "_isTextarea");
    /** Whether the input is inside of a form field. */
    __publicField(this, "_isInFormField");
    /**
     ...
     * @docs-private
     */
    __publicField(this, "controlType", "mat-input");
    /**
     * Implemented as part of MatFormFieldControl.
     * @docs-private
     */
    __publicField(this, "autofilled", false);
    ...
    __publicField(this, "_neverEmptyInputTypes", ["date", "datetime", "datetime-local", "month", "time", "week"].filter((t) => getSupportedInputTypes().has(t)));
    __publicField(this, "_iOSKeyupListener", (event) => {
    ...
    __publicField(this, "_webkitBlinkWheelListener", () => {
    });
    var _a2;
  ...
  get required() {
    ...
    return (_d2 = (_c11 = this._required) != null ? _c11 : (_b2 = (_a2 = this.ngControl) == null ? void 0 : _a2.control) == null ? void 0 : _b2.hasValidator(Validators.required)) != null ? _d2 : false;
  }
  set required(value) {
  ...
  _ensureWheelDefaultBehavior() {
    var _a2;
    (_a2 = this._cleanupWebkitWheel) == null ? void 0 : _a2.call(this);
...
__publicField(_MatInput, "\u0275fac", function MatInput_Factory(__ngFactoryType__) {
...
__publicField(_MatInputModule, "\u0275fac", function MatInputModule_Factory(__ngFactoryType__) {
...
var _MatRadioGroup = class _MatRadioGroup {
  constructor() {
    __publicField(this, "_changeDetector", inject(ChangeDetectorRef));
    /** Selected value for the radio group. */
    __publicField(this, "_value", null);
    /** The HTML name attribute applied to radio buttons in this group. */
    __publicField(this, "_name", inject(_IdGenerator).getId("mat-radio-group-"));
    /** The currently selected radio button. Should match value. */
    __publicField(this, "_selected", null);
    /** Whether the `value` has been set to its initial value. */
    __publicField(this, "_isInitialized", false);
    /** Whether the labels should appear after or before the radio-buttons. Defaults to 'after' */
    __publicField(this, "_labelPosition", "after");
    /** Whether the radio group is disabled. */
    __publicField(this, "_disabled", false);
    /** Whether the radio group is required. */
    __publicField(this, "_required", false);
    /** Subscription to changes in amount of radio buttons. */
    __publicField(this, "_buttonChanges");
    ...
    __publicField(this, "_disabledInteractive", false);
  }
...
__publicField(_MatRadioGroup, "\u0275fac", function MatRadioGroup_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatRadioGroup)();
});
__publicField(_MatRadioGroup, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
  type: _MatRadioGroup,
...
var _MatRadioButton = class _MatRadioButton {
  constructor() {
    ...
    __publicField(this, "_radioDispatcher", inject(UniqueSelectionDispatcher));
    __publicField(this, "_defaultOptions", inject(MAT_RADIO_DEFAULT_OPTIONS, {
      optional: true
    }));
    __publicField(this, "_ngZone", inject(NgZone));
    __publicField(this, "_renderer", inject(Renderer2));
    __publicField(this, "_uniqueId", inject(_IdGenerator).getId("mat-radio-"));
    __publicField(this, "_cleanupClick");
    /** The unique ID for the radio button. */
    __publicField(this, "id", this._uniqueId);
    ...
    __publicField(this, "disableRipple", false);
    /** Tabindex of the radio button. */
    __publicField(this, "tabIndex", 0);
    __publicField(this, "_labelPosition");
    __publicField(this, "_color");
    __publicField(this, "_disabledInteractive");
    /**
    ...
    __publicField(this, "_removeUniqueSelectionListener", () => {
    });
    /** Previous value of the input's tabindex. */
    __publicField(this, "_previousTabIndex");
    /** The native `<input type=radio>` element */
    __publicField(this, "_inputElement");
    /** Trigger elements for the ripple events. */
    __publicField(this, "_rippleTrigger");
    /** Whether animations are disabled. */
    __publicField(this, "_noopAnimations");
    __publicField(this, "_injector", inject(Injector));
    /** Called when the input is clicked. */
    __publicField(this, "_onInputClick", (event) => {
    ...
    this._disabledInteractive = (_b2 = (_a2 = this._defaultOptions) == null ? void 0 : _a2.disabledInteractive) != null ? _b2 : false;
    if (tabIndex) {
  ...
  _onTouchTargetClick(event) {
    ...
    if (!this.disabled || this.disabledInteractive) {
      (_a2 = this._inputElement) == null ? void 0 : _a2.nativeElement.focus();
    }
  }
  ...
  _updateTabIndex() {
    ...
    if (value !== this._previousTabIndex) {
      const input = (_a2 = this._inputElement) == null ? void 0 : _a2.nativeElement;
      if (input) {
        ...
        afterNextRender(() => {
          queueMicrotask(() => {
            ...
            if (group && group.selected && group.selected !== this && document.activeElement === input) {
              (_a3 = group.selected) == null ? void 0 : _a3._inputElement.nativeElement.focus();
...
__publicField(_MatRadioButton, "\u0275fac", function MatRadioButton_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatRadioButton)();
});
__publicField(_MatRadioButton, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
...
__publicField(_MatRadioModule, "\u0275fac", function MatRadioModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatRadioModule)();
});
__publicField(_MatRadioModule, "\u0275mod", /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _MatRadioModule
}));
__publicField(_MatRadioModule, "\u0275inj", /* @__PURE__ */ \u0275\u0275defineInjector({
...
var ComponentPortal = class extends Portal {
  constructor(component, viewContainerRef, injector, _componentFactoryResolver, projectableNodes) {
     ...
     */
    __publicField(this, "projectableNodes");
...
var BasePortalOutlet = class {
  constructor() {
    ...
    __publicField(this, "attachDomPortal", null);
  }
...
var DomPortalOutlet = class extends BasePortalOutlet {
  ...
  constructor(outletElement, _unusedComponentFactoryResolver, _appRef, _defaultInjector, _document) {
    super();
    __publicField(this, "outletElement");
    __publicField(this, "_appRef");
    __publicField(this, "_defaultInjector");
...
var _CdkPortalOutlet = class _CdkPortalOutlet extends BasePortalOutlet {
  constructor() {
    super();
    __publicField(this, "_moduleRef", inject(NgModuleRef$1, {
      optional: true
    }));
    __publicField(this, "_document", inject(DOCUMENT));
    ...
    __publicField(this, "_attachedRef");
    /** Emits when a portal is attached to the outlet. */
    __publicField(this, "attached", new EventEmitter());
    /**
...
var BlockScrollStrategy = class {
  constructor(_viewportRuler, document2) {
    ...
    __publicField(this, "_previousHTMLStyles", {
      top: "",
      left: ""
    });
    __publicField(this, "_previousScrollPosition");
...
var CloseScrollStrategy = class {
  constructor(_scrollDispatcher, _ngZone, _viewportRuler, _config) {
    __publicField(this, "_scrollDispatcher");
    __publicField(this, "_ngZone");
    __publicField(this, "_viewportRuler");
    __publicField(this, "_config");
    __publicField(this, "_scrollSubscription", null);
    __publicField(this, "_overlayRef");
    __publicField(this, "_initialScrollPosition");
...
var _ScrollStrategyOptions = class _ScrollStrategyOptions {
  constructor() {
    ...
    __publicField(this, "_viewportRuler", inject(ViewportRuler));
    __publicField(this, "_ngZone", inject(NgZone));
    __publicField(this, "_document", inject(DOCUMENT));
    /** Do nothing on scroll. */
    __publicField(this, "noop", () => new NoopScrollStrategy());
    /**
     * Close the overlay as soon as the user scrolls.
     * @param config Configuration to be used inside the scroll strategy.
     */
    __publicField(this, "close", (config) => new CloseScrollStrategy(this._scrollDispatcher, this._ngZone, this._viewportRuler, config));
    /** Block scrolling. */
    __publicField(this, "block", () => new BlockScrollStrategy(this._viewportRuler, this._document));
    /**
     * Update the overlay's position on scroll.
     * @param config Configuration to be used inside the scroll strategy.
     * Allows debouncing the reposition calls.
     */
    __publicField(this, "reposition", (config) => new RepositionScrollStrategy(this._scrollDispatcher, this._viewportRuler, this._ngZone, config));
  }
};
...
var OverlayConfig = class {
  constructor(config) {
    ...
    __publicField(this, "scrollStrategy", new NoopScrollStrategy());
    /** Custom class to add to the overlay pane. */
    __publicField(this, "panelClass", "");
    /** Whether the overlay has a backdrop. */
    __publicField(this, "hasBackdrop", false);
    /** Custom class to add to the backdrop */
    __publicField(this, "backdropClass", "cdk-overlay-dark-backdrop");
     ...
     */
    __publicField(this, "disposeOnNavigation", false);
    if (config) {
...
var ConnectedOverlayPositionChange = class {
  constructor(connectionPair, scrollableViewProperties) {
    __publicField(this, "connectionPair");
    __publicField(this, "scrollableViewProperties");
...
var _BaseOverlayDispatcher = class _BaseOverlayDispatcher {
  constructor() {
    ...
    __publicField(this, "_attachedOverlays", []);
    __publicField(this, "_document", inject(DOCUMENT));
...
var _OverlayKeyboardDispatcher = class _OverlayKeyboardDispatcher extends BaseOverlayDispatcher {
  constructor() {
    ...
    __publicField(this, "_ngZone", inject(NgZone));
    __publicField(this, "_renderer", inject(RendererFactory2).createRenderer(null, null));
    __publicField(this, "_cleanupKeydown");
    /** Keyboard event listener that will be attached to the body. */
    __publicField(this, "_keydownListener", (event) => {
...
var _OverlayOutsideClickDispatcher = class _OverlayOutsideClickDispatcher extends BaseOverlayDispatcher {
  constructor() {
    ...
    __publicField(this, "_ngZone", inject(NgZone));
    __publicField(this, "_renderer", inject(RendererFactory2).createRenderer(null, null));
    __publicField(this, "_cursorOriginalValue");
    __publicField(this, "_cursorStyleIsSet", false);
    __publicField(this, "_pointerDownEventTarget");
    __publicField(this, "_cleanups");
    /** Store pointerdown event target to track origin of click. */
    __publicField(this, "_pointerDownListener", (event) => {
      this._pointerDownEventTarget = _getEventTarget(event);
    });
    /** Click event listener that will be attached to the body propagate phase. */
    __publicField(this, "_clickListener", (event) => {
...
var _OverlayContainer = class _OverlayContainer {
  ...
  _createContainer() {
    ...
    if (this._platform.isBrowser || _isTestEnvironment()) {
      const oppositePlatformContainers = this._document.querySelectorAll(".".concat(containerClass, '[platform="server"], ') + ".".concat(containerClass, '[platform="test"]'));
...
var BackdropRef = class {
  constructor(document2, _renderer, _ngZone, onClick) {
    ...
    __publicField(this, "_cleanupClick");
    __publicField(this, "_cleanupTransitionEnd");
    __publicField(this, "_fallbackTimeout");
...
var OverlayRef = class {
  constructor(_portalOutlet, _host, _pane, _config, _ngZone, _keyboardDispatcher, _document, _location, _outsideClickDispatcher, _animationsDisabled = false, _injector, _renderer) {
    ...
    __publicField(this, "_config");
    __publicField(this, "_ngZone");
    __publicField(this, "_keyboardDispatcher");
    __publicField(this, "_document");
    __publicField(this, "_location");
    __publicField(this, "_outsideClickDispatcher");
    __publicField(this, "_animationsDisabled");
    __publicField(this, "_injector");
    __publicField(this, "_renderer");
    __publicField(this, "_backdropClick", new Subject());
    __publicField(this, "_attachments", new Subject());
    __publicField(this, "_detachments", new Subject());
    __publicField(this, "_positionStrategy");
    __publicField(this, "_scrollStrategy");
    __publicField(this, "_locationChanges", Subscription.EMPTY);
    __publicField(this, "_backdropRef", null);
    /**
     * Reference to the parent of the `_host` at the time it was detached. Used to restore
     * the `_host` to its original position in the DOM when it gets re-attached.
     */
    __publicField(this, "_previousHostParent");
    /** Stream of keydown events dispatched to this overlay. */
    __publicField(this, "_keydownEvents", new Subject());
    /** Stream of mouse outside events dispatched to this overlay. */
    __publicField(this, "_outsidePointerEvents", new Subject());
    __publicField(this, "_renders", new Subject());
    __publicField(this, "_afterRenderRef");
    /** Reference to the currently-running `afterNextRender` call. */
    __publicField(this, "_afterNextRenderRef");
  ...
  dispose() {
    ...
    (_c11 = this._afterNextRenderRef) == null ? void 0 : _c11.destroy();
...
var FlexibleConnectedPositionStrategy = class {
  constructor(connectedTo, _viewportRuler, _document, _platform, _overlayContainer) {
    ...
    __publicField(this, "_isInitialRender");
    /** Last size used for the bounding box. Used to avoid resizing the overlay after open. */
    __publicField(this, "_lastBoundingBoxSize", {
      width: 0,
      height: 0
    });
    /** Whether the overlay was pushed in a previous positioning. */
    __publicField(this, "_isPushed", false);
    /** Whether the overlay can be pushed on-screen on the initial open. */
    __publicField(this, "_canPush", true);
    /** Whether the overlay can grow via flexible width/height after the initial open. */
    __publicField(this, "_growAfterOpen", false);
    /** Whether the overlay's width and height can be constrained to fit within the viewport. */
    __publicField(this, "_hasFlexibleDimensions", true);
    /** Whether the overlay position is locked. */
    __publicField(this, "_positionLocked", false);
    /** Cached origin dimensions */
    __publicField(this, "_originRect");
    /** Cached overlay dimensions */
    __publicField(this, "_overlayRect");
    /** Cached viewport dimensions */
    __publicField(this, "_viewportRect");
    /** Cached container dimensions */
    __publicField(this, "_containerRect");
    /** Amount of space that must be maintained between the overlay and the edge of the viewport. */
    __publicField(this, "_viewportMargin", 0);
    /** The Scrollable containers used to check scrollable view properties on position change. */
    __publicField(this, "_scrollables", []);
    /** Ordered list of preferred positions, from most to least desirable. */
    __publicField(this, "_preferredPositions", []);
    ...
    __publicField(this, "_lastScrollVisibility");
    /** Subject that emits whenever the position changes. */
    __publicField(this, "_positionChanges", new Subject());
    ...
    __publicField(this, "_transformOriginSelector");
    /** Keeps track of the CSS classes that the position strategy has applied on the overlay panel. */
    __publicField(this, "_appliedPanelClasses", []);
    /** Amount by which the overlay was pushed in each axis during the last time it was positioned. */
    __publicField(this, "_previousPushAmount");
    /** Observable sequence of position changes. */
    __publicField(this, "positionChanges", this._positionChanges);
    this._viewportRuler = _viewportRuler;
    this._document = _document;
...
var GlobalPositionStrategy = class {
  constructor() {
    /** The overlay to which this strategy is attached. */
    __publicField(this, "_overlayRef");
    __publicField(this, "_cssPosition", "static");
    __publicField(this, "_topOffset", "");
    __publicField(this, "_bottomOffset", "");
    __publicField(this, "_alignItems", "");
    __publicField(this, "_xPosition", "");
    __publicField(this, "_xOffset", "");
...
var _Overlay = class _Overlay {
  constructor() {
    __publicField(this, "scrollStrategies", inject(ScrollStrategyOptions));
    __publicField(this, "_overlayContainer", inject(OverlayContainer));
    __publicField(this, "_positionBuilder", inject(OverlayPositionBuilder));
    __publicField(this, "_keyboardDispatcher", inject(OverlayKeyboardDispatcher));
    __publicField(this, "_injector", inject(Injector));
    __publicField(this, "_ngZone", inject(NgZone));
    __publicField(this, "_document", inject(DOCUMENT));
    __publicField(this, "_directionality", inject(Directionality));
    __publicField(this, "_location", inject(Location));
    __publicField(this, "_outsideClickDispatcher", inject(OverlayOutsideClickDispatcher));
    __publicField(this, "_animationsModuleType", inject(ANIMATION_MODULE_TYPE, {
      optional: true
    }));
    __publicField(this, "_idGenerator", inject(_IdGenerator));
    __publicField(this, "_renderer", inject(RendererFactory2).createRenderer(null, null));
...
var _CdkConnectedOverlay = class _CdkConnectedOverlay {
  ...
  constructor() {
    ...
    __publicField(this, "_overlayRef");
    __publicField(this, "_templatePortal");
    __publicField(this, "_backdropSubscription", Subscription.EMPTY);
    __publicField(this, "_attachSubscription", Subscription.EMPTY);
    __publicField(this, "_detachSubscription", Subscription.EMPTY);
    __publicField(this, "_positionSubscription", Subscription.EMPTY);
    __publicField(this, "_offsetX");
    __publicField(this, "_offsetY");
    __publicField(this, "_position");
    __publicField(this, "_scrollStrategyFactory", inject(CDK_CONNECTED_OVERLAY_SCROLL_STRATEGY));
    __publicField(this, "_disposeOnNavigation", false);
    __publicField(this, "_ngZone", inject(NgZone));
    ...
    __publicField(this, "viewportMargin", 0);
    /** Strategy to be used when handling scroll events while the overlay is open. */
    ...
    __publicField(this, "transformOriginSelector");
    /** Whether or not the overlay should attach a backdrop. */
    __publicField(this, "hasBackdrop", false);
    /** Whether or not the overlay should be locked when scrolling. */
    __publicField(this, "lockPosition", false);
    /** Whether the overlay's width and height can be constrained to fit within the viewport. */
    __publicField(this, "flexibleDimensions", false);
    /** Whether the overlay can grow after the initial open when flexible positioning is turned on. */
    __publicField(this, "growAfterOpen", false);
    /** Whether the overlay can be pushed on-screen if none of the provided positions fit. */
    __publicField(this, "push", false);
    /** Event emitted when the backdrop is clicked. */
    __publicField(this, "backdropClick", new EventEmitter());
    /** Event emitted when the position has changed. */
    __publicField(this, "positionChange", new EventEmitter());
    /** Event emitted when the overlay has been attached. */
    __publicField(this, "attach", new EventEmitter());
    /** Event emitted when the overlay has been detached. */
    __publicField(this, "detach", new EventEmitter());
    /** Emits when there are keyboard events that are targeted at the overlay. */
    __publicField(this, "overlayKeydown", new EventEmitter());
    /** Emits when there are mouse outside click events that are targeted at the overlay. */
    __publicField(this, "overlayOutsideClick", new EventEmitter());
    const templateRef = inject(TemplateRef);
    const viewContainerRef = inject(ViewContainerRef);
...
var _FullscreenOverlayContainer = class _FullscreenOverlayContainer extends OverlayContainer {
  constructor() {
    super();
    __publicField(this, "_renderer", inject(RendererFactory2).createRenderer(null, null));
    __publicField(this, "_fullScreenEventName");
    __publicField(this, "_cleanupFullScreenListener");
  }
  ngOnDestroy() {
    var _a2;
    super.ngOnDestroy();
...
var _c04 = ["*", [["mat-option"], ["ng-container"]]];
...
var _MatOptgroup = class _MatOptgroup {
  constructor() {
    ...
    __publicField(this, "_labelId", inject(_IdGenerator).getId("mat-optgroup-label-"));
    /** Whether the group is in inert a11y mode. */
    __publicField(this, "_inert");
    var _a2;
...
__publicField(_MatOptgroup, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
  type: _MatOptgroup,
...
var MatOptionSelectionChange = class {
  constructor(source, isUserInput = false) {
    __publicField(this, "source");
    __publicField(this, "isUserInput");
    this.source = source;
...
var _MatOption = class _MatOption {
  constructor() {
    ...
    __publicField(this, "_changeDetectorRef", inject(ChangeDetectorRef));
    __publicField(this, "_parent", inject(MAT_OPTION_PARENT_COMPONENT, {
      optional: true
    }));
    __publicField(this, "group", inject(MAT_OPTGROUP, {
      optional: true
    }));
    __publicField(this, "_signalDisableRipple", false);
    __publicField(this, "_selected", false);
    __publicField(this, "_active", false);
    __publicField(this, "_disabled", false);
    __publicField(this, "_mostRecentViewValue", "");
    /** The form value of the option. */
    __publicField(this, "value");
    /** The unique ID of the option. */
    __publicField(this, "id", inject(_IdGenerator).getId("mat-option-"));
  ...
  get disableRipple() {
    var _a2;
    return this._signalDisableRipple ? this._parent.disableRipple() : !!((_a2 = this._parent) == null ? void 0 : _a2.disableRipple);
  }
...
__publicField(_MatOption, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
  type: _MatOption,
...
__publicField(_MatOptionModule, "\u0275mod", /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _MatOptionModule
}));
__publicField(_MatOptionModule, "\u0275inj", /* @__PURE__ */ \u0275\u0275defineInjector({
...
var _MatSelect = class _MatSelect {
  constructor() {
    ...
    __publicField(this, "_idGenerator", inject(_IdGenerator));
    __publicField(this, "_renderer", inject(Renderer2));
    __publicField(this, "_parentFormField", inject(MAT_FORM_FIELD, {
      optional: true
    }));
    __publicField(this, "ngControl", inject(NgControl, {
      self: true,
    ...
    __publicField(this, "_liveAnnouncer", inject(LiveAnnouncer));
    __publicField(this, "_defaultOptions", inject(MAT_SELECT_CONFIG, {
      optional: true
    }));
    __publicField(this, "_animationsDisabled", inject(ANIMATION_MODULE_TYPE, {
      optional: true
    }) === "NoopAnimations");
    __publicField(this, "_initialized", new Subject());
    __publicField(this, "_cleanupDetach");
    ...
    __publicField(this, "customTrigger");
    /**
    ...
    __publicField(this, "_scrollStrategyFactory", inject(MAT_SELECT_SCROLL_STRATEGY));
    /** Whether or not the overlay panel is open. */
    __publicField(this, "_panelOpen", false);
    /** Comparison function to specify which option is displayed. Defaults to object equality. */
    __publicField(this, "_compareWith", (o1, o2) => o1 === o2);
    /** Unique id for this input. */
    __publicField(this, "_uid", this._idGenerator.getId("mat-select-"));
    /** Current `aria-labelledby` value for the select trigger. */
    __publicField(this, "_triggerAriaLabelledBy", null);
    /**
     * Keeps track of the previous form control assigned to the select.
     * Used to detect if it has changed.
     */
    __publicField(this, "_previousControl");
    /** Emits whenever the component is destroyed. */
    __publicField(this, "_destroy", new Subject());
    ...
    __publicField(this, "_preferredOverlayOrigin");
    /** Width of the overlay panel. */
    __publicField(this, "_overlayWidth");
    ...
    __publicField(this, "_valueId", this._idGenerator.getId("mat-select-value-"));
    /** Strategy that will be used to handle scrolling while the select panel is open. */
    __publicField(this, "_scrollStrategy");
    __publicField(this, "_overlayPanelClass", ((_a = this._defaultOptions) == null ? void 0 : _a.overlayPanelClass) || "");
    __publicField(this, "_focused", false);
    /** A name for this control that can be used by `mat-form-field`. */
    __publicField(this, "controlType", "mat-select");
    /** Trigger that opens the select. */
    __publicField(this, "trigger");
    /** Panel containing the select options. */
    __publicField(this, "panel");
    /** Overlay pane containing the options. */
    __publicField(this, "_overlayDir");
    ...
    __publicField(this, "tabIndex", 0);
    __publicField(this, "_hideSingleSelectionIndicator", (_c = (_b = this._defaultOptions) == null ? void 0 : _b.hideSingleSelectionIndicator) != null ? _c : false);
    __publicField(this, "_placeholder");
    __publicField(this, "_required");
    __publicField(this, "_multiple", false);
    /** Whether to center the active option over the trigger. */
    __publicField(this, "disableOptionCentering", (_e = (_d = this._defaultOptions) == null ? void 0 : _d.disableOptionCentering) != null ? _e : false);
    ...
    __publicField(this, "typeaheadDebounceInterval");
    /**
     * Function used to sort the values in a select in multiple mode.
     * Follows the same logic as `Array.prototype.sort`.
     */
    __publicField(this, "sortComparator");
    __publicField(this, "_id");
    /**
     * Width of the panel. If set to `auto`, the panel will match the trigger width.
     * If set to null or an empty string, the panel will grow to match the longest option's text.
     */
    __publicField(this, "panelWidth", this._defaultOptions && typeof this._defaultOptions.panelWidth !== "undefined" ? this._defaultOptions.panelWidth : "auto");
    /**
     ...
     */
    __publicField(this, "canSelectNullableOptions", (_g = (_f = this._defaultOptions) == null ? void 0 : _f.canSelectNullableOptions) != null ? _g : false);
    /** Combined stream of all of the child options' change events. */
    __publicField(this, "optionSelectionChanges", defer(() => {
    ...
    __publicField(this, "openedChange", new EventEmitter());
     ...
     */
    __publicField(this, "_trackedModal", null);
    ...
    // options.
    __publicField(this, "_skipPredicate", (option) => {
      if (this.panelOpen) {
        return false;
      }
  ...
  _applyModalPanelOwnership() {
    ...
    const panelId = "".concat(this.id, "-panel");
...
__publicField(_MatSelect, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({
  type: _MatSelect,
...
__publicField(_MatSelectTrigger, "\u0275dir", /* @__PURE__ */ \u0275\u0275defineDirective({
...
__publicField(_MatSelectModule, "\u0275mod", /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _MatSelectModule
}));
__publicField(_MatSelectModule, "\u0275inj", /* @__PURE__ */ \u0275\u0275defineInjector({
...
var _MatTabContent = class _MatTabContent {
  constructor() {
    __publicField(this, "template", inject(TemplateRef));
  }
};
__publicField(_MatTabContent, "\u0275fac", function MatTabContent_Factory(__ngFactoryType__) {
...
var _MatTabLabel = class _MatTabLabel extends CdkPortal {
  constructor() {
    super(...arguments);
    __publicField(this, "_closestTab", inject(MAT_TAB, {
      optional: true
    }));
  }
};
...
var _MatTab = class _MatTab {
  constructor() {
    __publicField(this, "_viewContainerRef", inject(ViewContainerRef));
    __publicField(this, "_closestTabGroup", inject(MAT_TAB_GROUP, {
      optional: true
    }));
    /** whether the tab is disabled. */
    __publicField(this, "disabled", false);
    __publicField(this, "_templateLabel");
    /**
     * Template provided in the tab content that will be used if present, used to enable lazy-loading
     */
    __publicField(this, "_explicitContent");
    /** Template inside the MatTab view that contains an `<ng-content>`. */
    __publicField(this, "_implicitContent");
    /** Plain text label for the tab, used when there is no template label. */
    __publicField(this, "textLabel", "");
    ...
    __publicField(this, "labelClass");
    /** Classes to be passed to the tab mat-tab-body container. */
    __publicField(this, "bodyClass");
    /**
    ...
    __publicField(this, "_contentPortal", null);
...
__publicField(_MatTab, "\u0275fac", function MatTab_Factory(__ngFactoryType__) {
...
var MatInkBar = class {
  constructor(_items) {
    ...
    __publicField(this, "_currentItem");
    this._items = _items;
  }
  /** Hides the ink bar. */
  hide() {
  ...
  alignToElement(element) {
    ...
    if (correspondingItem) {
      const domRect = (_b2 = currentItem == null ? void 0 : (_a2 = currentItem.elementRef.nativeElement).getBoundingClientRect) == null ? void 0 : _b2.call(_a2);
...
var _InkBarItem = class _InkBarItem {
  constructor() {
    __publicField(this, "_elementRef", inject(ElementRef));
    __publicField(this, "_inkBarElement");
    __publicField(this, "_inkBarContentElement");
    __publicField(this, "_fitToContent", false);
  }
  ...
  activateInkBar(previousIndicatorClientRect) {
    ...
    this._inkBarContentElement.style.setProperty("transform", "translateX(".concat(xPosition, "px) scaleX(").concat(widthDelta, ")"));
  ...
  ngOnDestroy() {
    var _a2;
    (_a2 = this._inkBarElement) == null ? void 0 : _a2.remove();
...
__publicField(_InkBarItem, "\u0275fac", function InkBarItem_Factory(__ngFactoryType__) {
...
var _MatPaginatedTabHeader = class _MatPaginatedTabHeader {
  constructor() {
    ...
    __publicField(this, "_ngZone", inject(NgZone));
    __publicField(this, "_platform", inject(Platform));
    __publicField(this, "_sharedResizeObserver", inject(SharedResizeObserver));
    __publicField(this, "_injector", inject(Injector));
    __publicField(this, "_renderer", inject(Renderer2));
    ...
    __publicField(this, "_scrollDistance", 0);
    /** Whether the header should scroll to the selected index after the view has been checked. */
    __publicField(this, "_selectedIndexChanged", false);
    /** Emits when the component is destroyed. */
    __publicField(this, "_destroyed", new Subject());
    /** Whether the controls for pagination should be displayed */
    __publicField(this, "_showPaginationControls", false);
    /** Whether the tab list can be scrolled more towards the end of the tab label list. */
    __publicField(this, "_disableScrollAfter", true);
    /** Whether the tab list can be scrolled more towards the beginning of the tab label list. */
    __publicField(this, "_disableScrollBefore", true);
    /**
     * The number of tab labels that are displayed on the header. When this changes, the header
     * should re-evaluate the scroll position.
     */
    __publicField(this, "_tabLabelCount");
    /** Whether the scroll distance has changed and should be applied after the view is checked. */
    __publicField(this, "_scrollDistanceChanged");
    /** Used to manage focus between the tabs. */
    __publicField(this, "_keyManager");
    /** Cached text content of the header. */
    __publicField(this, "_currentTextContent");
    /** Stream that will stop the automated scrolling. */
    __publicField(this, "_stopScrolling", new Subject());
    /**
     * Whether pagination should be disabled. This can be used to avoid unnecessary
     * layout recalculations if it's known that pagination won't be required.
     */
    __publicField(this, "disablePagination", false);
...
__publicField(_MatPaginatedTabHeader, "\u0275fac", function MatPaginatedTabHeader_Factory(__ngFactoryType__) {
...
var _MatTabHeader = class _MatTabHeader extends MatPaginatedTabHeader {
  constructor() {
    super(...arguments);
    __publicField(this, "_items");
    __publicField(this, "_tabListContainer");
    __publicField(this, "_tabList");
    __publicField(this, "_tabListInner");
    __publicField(this, "_nextPaginator");
    __publicField(this, "_previousPaginator");
    __publicField(this, "_inkBar");
...
var _MatTabBodyPortal = class _MatTabBodyPortal extends CdkPortalOutlet {
  constructor() {
    super();
    __publicField(this, "_host", inject(MatTabBody));
    /** Subscription to events for when the tab body begins centering. */
    __publicField(this, "_centeringSub", Subscription.EMPTY);
    /** Subscription to events for when the tab body finishes leaving from center position. */
    __publicField(this, "_leavingSub", Subscription.EMPTY);
  }
...
__publicField(_MatTabBodyPortal, "\u0275fac", function MatTabBodyPortal_Factory(__ngFactoryType__) {
...
var _MatTabBody = class _MatTabBody {
  constructor() {
    ...
    __publicField(this, "_injector", inject(Injector));
    __publicField(this, "_renderer", inject(Renderer2));
    __publicField(this, "_animationsModule", inject(ANIMATION_MODULE_TYPE, {
      optional: true
    }));
    __publicField(this, "_eventCleanups");
    __publicField(this, "_initialized");
    __publicField(this, "_fallbackTimer");
    /** Current position of the tab-body in the tab-group. Zero means that the tab is visible. */
    __publicField(this, "_positionIndex");
    /** Subscription to the directionality change observable. */
    __publicField(this, "_dirChangeSubscription", Subscription.EMPTY);
    /** Current position of the body within the tab group. */
    __publicField(this, "_position");
    /** Previous position of the body. */
    __publicField(this, "_previousPosition");
    /** Event emitted when the tab begins to animate towards the center as the active tab. */
    __publicField(this, "_onCentering", new EventEmitter());
    /** Event emitted before the centering of the tab begins. */
    __publicField(this, "_beforeCentering", new EventEmitter());
    /** Event emitted before the centering of the tab begins. */
    __publicField(this, "_afterLeavingCenter", new EventEmitter());
    /** Event emitted when the tab completes its animation towards the center. */
    __publicField(this, "_onCentered", new EventEmitter(true));
    /** The portal host inside of this container into which the tab body content will be loaded. */
    __publicField(this, "_portalHost");
    /** Element in which the content is rendered. */
    __publicField(this, "_contentElement");
    /** The tab body content to display. */
    __publicField(this, "_content");
    // Note that the default value will always be overwritten by `MatTabBody`, but we need one
    // anyway to prevent the animations module from throwing an error if the body is used on its own.
    /** Duration for the tab's animation. */
    __publicField(this, "animationDuration", "500ms");
    /** Whether the tab's content should be kept in the DOM while it's off-screen. */
    __publicField(this, "preserveContent", false);
    if (this._dir) {
  ...
  ngOnDestroy() {
    ...
    (_a2 = this._eventCleanups) == null ? void 0 : _a2.forEach((cleanup) => cleanup());
  ...
  _bindTransitionEvents() {
    this._ngZone.runOutsideAngular(() => {
      ...
      const transitionDone = (event) => {
        var _a2;
        if (event.target === ((_a2 = this._contentElement) == null ? void 0 : _a2.nativeElement)) {
...
__publicField(_MatTabBody, "\u0275fac", function MatTabBody_Factory(__ngFactoryType__) {
...
var _MatTabGroup = class _MatTabGroup {
  constructor() {
    ...
    __publicField(this, "_changeDetectorRef", inject(ChangeDetectorRef));
    __publicField(this, "_ngZone", inject(NgZone));
    __publicField(this, "_tabsSubscription", Subscription.EMPTY);
    __publicField(this, "_tabLabelSubscription", Subscription.EMPTY);
    __publicField(this, "_tabBodySubscription", Subscription.EMPTY);
    __publicField(this, "_diAnimationsDisabled", inject(ANIMATION_MODULE_TYPE, {
      optional: true
    }) === "NoopAnimations");
    /**
     ...
     */
    __publicField(this, "_allTabs");
    __publicField(this, "_tabBodies");
    __publicField(this, "_tabBodyWrapper");
    __publicField(this, "_tabHeader");
    /** All of the tabs that belong to the group. */
    __publicField(this, "_tabs", new QueryList());
    /** The tab index that should be selected after the content has been checked. */
    __publicField(this, "_indexToSelect", 0);
    /** Index of the tab that was focused last. */
    __publicField(this, "_lastFocusedTabIndex", null);
    /** Snapshot of the height of the tab body wrapper before another tab is activated. */
    __publicField(this, "_tabBodyWrapperHeight", 0);
    /**
     ...
     */
    __publicField(this, "color");
    __publicField(this, "_fitInkBarToContent", false);
    /** Whether tabs should be stretched to fill the header. */
    __publicField(this, "stretchTabs", true);
    /** Alignment for tabs label. */
    __publicField(this, "alignTabs", null);
    /** Whether the tab group should grow to the size of the active tab. */
    __publicField(this, "dynamicHeight", false);
    __publicField(this, "_selectedIndex", null);
    /** Position of the tab header. */
    __publicField(this, "headerPosition", "above");
    __publicField(this, "_animationDuration");
    __publicField(this, "_contentTabIndex");
    /**
     * Whether pagination should be disabled. This can be used to avoid unnecessary
     * layout recalculations if it's known that pagination won't be required.
     */
    ...
    __publicField(this, "selectedIndexChange", new EventEmitter());
    /** Event emitted when focus has changed within a tab group. */
    __publicField(this, "focusChange", new EventEmitter());
    /** Event emitted when the body animation has completed */
    __publicField(this, "animationDone", new EventEmitter());
    /** Event emitted when the tab selection has changed. */
    __publicField(this, "selectedTabChange", new EventEmitter(true));
    __publicField(this, "_groupId");
    /** Whether the tab group is rendered on the server. */
    __publicField(this, "_isServer", !inject(Platform).isBrowser);
  ...
  set backgroundColor(value) {
    const classList = this._elementRef.nativeElement.classList;
    classList.remove("mat-tabs-with-background", "mat-background-".concat(this.backgroundColor));
    if (value) {
      classList.add("mat-tabs-with-background", "mat-background-".concat(value));
    }
  ...
  _getTabLabelId(tab, index) {
    return tab.id || "".concat(this._groupId, "-label-").concat(index);
  }
  /** Returns a unique id for each tab content element */
  _getTabContentId(index) {
    return "".concat(this._groupId, "-content-").concat(index);
  }
  /**
  ...
  _getTabIndex(index) {
    var _a2;
    const targetIndex = (_a2 = this._lastFocusedTabIndex) != null ? _a2 : this.selectedIndex;
  ...
  _bodyCentered(isCenter) {
    var _a2;
    if (isCenter) {
      (_a2 = this._tabBodies) == null ? void 0 : _a2.forEach((body, i) => body._setActiveClass(i === this._selectedIndex));
    }
  }
  _animationsDisabled() {
...
__publicField(_MatTabGroup, "\u0275fac", function MatTabGroup_Factory(__ngFactoryType__) {
...
var _MatTabNav = class _MatTabNav extends MatPaginatedTabHeader {
  constructor() {
    ...
    __publicField(this, "_fitInkBarToContent", new BehaviorSubject(false));
    /** Whether tabs should be stretched to fill the header. */
    __publicField(this, "stretchTabs", true);
    __publicField(this, "_animationDuration");
...
__publicField(_MatTabNav, "\u0275fac", function MatTabNav_Factory(__ngFactoryType__) {
...
var _MatTabLink = class _MatTabLink extends InkBarItem {
  constructor() {
    super();
    __publicField(this, "_tabNavBar", inject(MatTabNav));
    __publicField(this, "elementRef", inject(ElementRef));
    __publicField(this, "_focusMonitor", inject(FocusMonitor));
    __publicField(this, "_destroyed", new Subject());
    ...
    __publicField(this, "id", inject(_IdGenerator).getId("mat-tab-link-"));
    inject(_CdkPrivateStyleLoader).load(_StructuralStylesLoader);
  ...
  _getAriaControls() {
    var _a2;
    return this._tabNavBar.tabPanel ? (_a2 = this._tabNavBar.tabPanel) == null ? void 0 : _a2.id : this.elementRef.nativeElement.getAttribute("aria-controls");
  }
  _getAriaSelected() {
...
__publicField(_MatTabLink, "\u0275fac", function MatTabLink_Factory(__ngFactoryType__) {
...
var _MatTabNavPanel = class _MatTabNavPanel {
  constructor() {
    ...
    __publicField(this, "id", inject(_IdGenerator).getId("mat-tab-nav-panel-"));
    /** Id of the active tab in the nav bar. */
    __publicField(this, "_activeTabId");
  }
};
__publicField(_MatTabNavPanel, "\u0275fac", function MatTabNavPanel_Factory(__ngFactoryType__) {
...
__publicField(_MatTabsModule, "\u0275fac", function MatTabsModule_Factory(__ngFactoryType__) {
...
// src/app/shared/NgxMatHighlightDirective.ts
var _NgxMatHighlightDirective = class _NgxMatHighlightDirective {
  constructor(eltRef) {
    this.eltRef = eltRef;
  }
  ngAfterViewInit() {
...
_NgxMatHighlightDirective.\u0275fac = function NgxMatHighlightDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxMatHighlightDirective)(\u0275\u0275directiveInject(ElementRef));
};
_NgxMatHighlightDirective.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({ type: _NgxMatHighlightDirective, selectors: [["code", "ngxMatHighlight", ""]], standalone: false });
var NgxMatHighlightDirective = _NgxMatHighlightDirective;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxMatHighlightDirective, [{
    type: Directive,
    args: [{
...
_SharedModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [MatTabsModule, MatTabsModule] });
...
var DateAdapter = class {
  constructor() {
    ...
    __publicField(this, "_localeChanges", new Subject());
    /** A stream that emits when the locale changes. */
    __publicField(this, "localeChanges", this._localeChanges);
  }
  /**
...
//# sourceMappingURL=chunk-DAIRKQZL.js.map
