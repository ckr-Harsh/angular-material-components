...
export declare class NgxMatTimepickerComponent<D> implements ControlValueAccessor, OnInit, OnChanges {
    ...
    private _destroyed;
    pattern: RegExp;
    constructor(cd: ChangeDetectorRef, _dateAdapter: NgxMatDateAdapter<D>);
    ngOnInit(): void;
