...
declare abstract class NgxMatDateRangeInputPartBase<D> extends NgxMatDatepickerInputBase<NgxDateRange<D>> implements OnInit, DoCheck {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxMatDateRangeInputPartBase<any>, never, never, {}, {}, never, never, true, never>;
}
/** Input for entering the start date in a `mat-date-range-input`. */
export declare class NgxMatStartDate<D> extends NgxMatDateRangeInputPartBase<D> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxMatStartDate<any>, "input[ngxMatStartDate]", never, { "errorStateMatcher": { "alias": "errorStateMatcher"; "required": false; }; }, { "dateChange": "dateChange"; "dateInput": "dateInput"; }, never, never, false, never>;
}
/** Input for entering the end date in a `mat-date-range-input`. */
export declare class NgxMatEndDate<D> extends NgxMatDateRangeInputPartBase<D> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxMatEndDate<any>, "input[ngxMatEndDate]", never, { "errorStateMatcher": { "alias": "errorStateMatcher"; "required": false; }; }, { "dateChange": "dateChange"; "dateInput": "dateInput"; }, never, never, false, never>;
}
export {};
